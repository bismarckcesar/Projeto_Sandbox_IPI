...
<body class= "back-img">		
	...
	<div class="container div-sobre pt-3 rounded bg-light text-dark">
		...
		<h5 class="text-center">Visão</h5>
			<p>Ser uma ferramenta de referência no âmbito nutricional.</p>
		<h5 class="text-center">Valores</h5>
		<ul class="text-left">
			<li><strong>Qualidade</strong>: busca da melhoria contínua.</li>
