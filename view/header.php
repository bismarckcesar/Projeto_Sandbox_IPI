...
<?php require_once('../actions/init.php'); ?>
...
<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-color-custom">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <form class="container-fluid mx-0 px-0 d-flex" action="../view/search.php" method="GET" name="patient">

      <?php if ($_SESSION['role'] == 1): ?>
            
        <input class="form-control me-1" type="search" placeholder="Pesquise determinado paciente para criar seu plano alimentar..." aria-label="Search" name="patient">
